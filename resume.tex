...
\section{\color{airforceblue}WORK EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software developer/Student assessor, Storrs, Connecticut}{September 2023 - Present}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Team member(Data acquisition sub-team), Storrs, Connecticut}{August 2023 - Present}
      \resumeItemListStart
            \resumeItem{\normalsize{Prepare, organize, and facilitate track and test days.}}
            \resumeItem{\normalsize{As a UConn FSAE Data Acquisition (DAQ) team member, I set up telemetry sensors using electrical skills and analyzed the recorded data using Python.}}  
      \resumeItemListEnd  

    \resumeSubheading
      {FROST Robotics}{} 
      {Financial Officer/Team member, Storrs, Connecticut}{January 2024 - Present}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Teaching Assistant, Hartford, Connecticut}{August 2022 - June 2023}
      \resumeItemListStart
   ...
   \resumeSubheading
      ...
      {Captain and Sub-team Lead, Hartford, Connecticut}{August 2019 - June 2023}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Lead Student Mentor, Hartford, Connecticut}{August 2022 - Mayune 2023}
      \resumeItemListStart
