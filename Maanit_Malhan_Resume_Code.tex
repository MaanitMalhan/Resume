...
\section{\color{airforceblue}WORK EXPERIENCE}
 ...
 \resumeSubheading
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
            \resumeItem{\normalsize{Developing a web application featuring auto-fill functionality, dynamically populating fields based on previously entered data associated with specific codes.}}  
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
            \resumeItem{\normalsize{As a UConn FSAE Data Acquisition (DAQ) team member, I utilized electrical skills to set up telemetry sensors and analyzed recorded data with Python to enhance our car's performance.}}  
      \resumeItemListEnd  
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
            \resumeItem{\normalsize{Instructed a class of 25 students in PLTW Principles of Engineering. Offering one-on-one and small-group student assistance during class. }}
