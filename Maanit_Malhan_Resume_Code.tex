...
\onehalfspacing % Apply 1.5 line spacing to the entire document
...
\section{\color{airforceblue}WORK EXPERIENCE}
 ...
 \resumeSubheading
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
            \resumeItem{\normalsize{As a UConn FSAE Data Acquisition (DAQ) team member, I utilized electrical skills to set up telemetry sensors and analyzed and plotted recorded data with Python to enhance our car's performance.}}  
      \resumeItemListEnd  
